...
import com.findincommon.app.payload.ApiResponse;
import com.findincommon.app.payload.AuthResponse;
import com.findincommon.app.payload.LoginRequest;
import com.findincommon.app.payload.SignUpRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        URI location = ServletUriComponentsBuilder
                .fromCurrentContextPath().path("/api/users/user/info")
